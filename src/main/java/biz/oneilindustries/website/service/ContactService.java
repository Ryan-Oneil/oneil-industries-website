...
public class ContactService {
    ...
    private static final String RECIEVER_EMAIL = "kreytonkrey@gmail.com\n";
    ...
    public void registerFeedback(ContactForm contactForm, String ip) {
        ...
        emailSender.sendSimpleEmail(RECIEVER_EMAIL,contactForm.getSubject(),contactForm.getMessage() + "\n From " + contactForm.getName(),contactForm.getName(), contactForm.getEmail());
    }
}
