        ...
        <div className="column twelve wide">
          ...
          >
            <div className="ui segment">
              <h1 className="textFormat">Edit Album</h1>
              <label className="textFormat">Album Name</label>
              <Field name="newAlbumName" component={renderInput} type="text" />
              <label className="textFormat">Show unlisted images</label>
              <Field
                name="showUnlistedImages"
                component="select"
                className="field"
              >
...
export default connect(null, { updateAlbum })(
  reduxForm({ form: "editAlbum", enableReinitialize: true, validate })(
    EditAlbumForm
  )
);
