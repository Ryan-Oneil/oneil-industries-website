...
class ResetPasswordForm extends React.Component {
  ...
  render() {
    const { submitting, login, signUp, error } = this.props;
    const { message, hasSentResetEmail } = this.props.auth;
...
export default connect(mapStateToProps, { resetPassword })(
  reduxForm({ form: "resetPassword", enableReinitialize: true, validate })(
    ResetPasswordForm
  )
);
