import {
    ...
    UPDATE_USER_DETAILS_SENT, USER_PROFILE_GENERATE_API_TOKEN, USER_PROFILE_GENERATE_SHAREX_CONFIG,
    USER_PROFILE_GET, USER_PROFILE_GET_API_TOKENS,
...
export default (state = {
    ...
    switch (action.type) {
        case USER_PROFILE_GET: {
            ...
            return {...state, userDiscord, userTeamspeak, user, storageQuota, errorMessage : ""};
        }
