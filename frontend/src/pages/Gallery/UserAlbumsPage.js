  ...
  render() {
    return (
      <div className="marginPadding">
        <h1 className="ui center aligned header">{this.props.user}'s Albums</h1>
        ...
        {this.state.isOpen && (
          ...
          >
            <div className="image">
              <Media
                media={this.state.album.media[0]}
            ...
            <div className="centerText">
              <EditForm
                ...
                initialValues={{
                  newAlbumName: this.state.album.album.name,
...
export default connect(mapStateToProps, { fetchAlbum: fetchAlbums })(
  UserAlbumsPage
);
