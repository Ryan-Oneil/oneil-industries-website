            ...
            <div className="ui padded grid">
                ...
                <div className="ui six wide column">
                    <DetailBox header="Account Details">
                        ...
                        <p><strong>Account Enabled:</strong> {user.enabled ? 'Yes' : 'No'}</p>
        ...
        return (
            <div className="ui padded equal width grid">
                <SideBarNav headerText="Profile Dashboard" headerIcon="hdd">
                    <NavLink to={match.path} className="item" exact={true}><i className="icon chart user"/>Account</NavLink>
                    <NavLink to={`${match.path}/services`} className="item"><i className="icon globe"/>Services</NavLink>
                    <NavLink to={`${match.path}/api`} className="item"><i className="icon server"/>Api</NavLink>
                </SideBarNav>
                <div className="sixteen wide mobile thirteen wide tablet thirteen wide computer right floated column">
                    <Switch>
                        <PrivateRoute>
                            ...
                            <Route exact path={`${match.path}/services`} component={ManageServices} />
