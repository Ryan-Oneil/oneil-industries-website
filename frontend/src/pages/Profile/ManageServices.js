    ...
    render() {
        ...
        return (
            <div className="ui padded grid">
                {userTeamspeak && <div className="ui six wide column">
                    <DetailBox header="Teamspeak">
                        {UserServiceTable(userTeamspeak, this.props.deleteUserService, "teamspeak")}
                        <button className="ui primary button centerButton" onClick={() => {this.displayServiceModal(teamspeakUsers, "teamspeak")}}>Add</button>
                    </DetailBox>
                </div>
                }
                {userDiscord && <div className="ui six wide column">
                    <DetailBox header="Discord">
                        {UserServiceTable(userDiscord, this.props.deleteUserService, "discord")}
